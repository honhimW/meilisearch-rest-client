...
class ReactiveSortableAttributesSettingsImpl extends AbstractReactiveImpl implements ReactiveSortableAttributesSettings {

    private static final String PATH = "/indexes/%s/settings/sortable-attributes";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveSortableAttributesSettingsImpl(ReactiveSettingsImpl settings) {
