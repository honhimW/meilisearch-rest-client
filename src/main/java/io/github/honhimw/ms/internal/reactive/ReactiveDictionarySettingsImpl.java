...
class ReactiveDictionarySettingsImpl extends AbstractReactiveImpl implements ReactiveDictionarySettings {

    private static final String PATH = "/indexes/%s/settings/dictionary";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveDictionarySettingsImpl(ReactiveSettingsImpl settings) {
