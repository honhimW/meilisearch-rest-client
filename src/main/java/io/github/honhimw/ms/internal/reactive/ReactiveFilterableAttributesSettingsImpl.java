...
class ReactiveFilterableAttributesSettingsImpl extends AbstractReactiveImpl implements ReactiveFilterableAttributesSettings {

    private static final String PATH = "/indexes/%s/settings/filterable-attributes";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveFilterableAttributesSettingsImpl(ReactiveSettingsImpl settings) {
