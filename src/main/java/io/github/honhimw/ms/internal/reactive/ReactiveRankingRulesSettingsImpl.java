...
class ReactiveRankingRulesSettingsImpl extends AbstractReactiveImpl implements ReactiveRankingRulesSettings {

    private static final String PATH = "/indexes/%s/settings/ranking-rules";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveRankingRulesSettingsImpl(ReactiveSettingsImpl settings) {
