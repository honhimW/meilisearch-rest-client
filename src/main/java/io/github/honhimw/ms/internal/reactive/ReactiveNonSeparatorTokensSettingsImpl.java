...
class ReactiveNonSeparatorTokensSettingsImpl extends AbstractReactiveImpl implements ReactiveNonSeparatorTokensSettings {

    private static final String PATH = "/indexes/%s/settings/non-separator-tokens";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveNonSeparatorTokensSettingsImpl(ReactiveSettingsImpl settings) {
