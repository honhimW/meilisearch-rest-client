...
class ReactiveStopWordsSettingsImpl extends AbstractReactiveImpl implements ReactiveStopWordsSettings {

    private static final String PATH = "/indexes/%s/settings/stop-words";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveStopWordsSettingsImpl(ReactiveSettingsImpl settings) {
