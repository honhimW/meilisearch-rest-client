...
class DisplayedAttributesSettingsImpl implements DisplayedAttributesSettings {
    ...
    @Override
    public TaskInfo update(List<String> displayedAttributes) {
        return ReactorUtils.blockNonNull(_reactive.update(displayedAttributes));
    }
