...
class ReactiveDisplayedAttributesSettingsImpl extends AbstractReactiveImpl implements ReactiveDisplayedAttributesSettings {

    private static final String PATH = "/indexes/%s/settings/displayed-attributes";

    private final ReactiveSettingsImpl _settings;

    private final String path;

    protected ReactiveDisplayedAttributesSettingsImpl(ReactiveSettingsImpl settings) {
