...
class SeparatorTokensSettingsImpl implements SeparatorTokensSettings {
    ...
    @Override
    public TaskInfo update(List<String> separatorTokens) {
        return ReactorUtils.blockNonNull(_reactive.update(separatorTokens));
    }
