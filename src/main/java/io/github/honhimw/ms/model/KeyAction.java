...
public enum KeyAction implements EnumValue<KeyAction> {
    ...
    /**
     * Provides access to the get one document, get documents with POST, and get documents with GET endpoints
     */
    ...
    /**
     * Provides access to the delete one document, delete all documents, batch delete, and delete by filter endpoints
     */
    ...
    /**
     * Provides access to the swap indexes endpoint. Non-authorized indexes will not be swapped
     */
    INDEXES_SWAP("indexes.swap", "Provides access to the swap indexes endpoint. Non-authorized indexes will not be swapped"),
    /**
     * Provides access to the get one task and get tasks endpoints. Tasks from non-authorized indexes will be omitted from the response
     */
    ...
    /**
     * Provides access to the cancel tasks endpoint. Tasks from non-authorized indexes will not be canceled
     */
    ...
    /**
     * Provides access to the delete tasks endpoint. Tasks from non-authorized indexes will not be deleted
     */
    ...
    /**
     * Provides access to the create snapshot endpoint. Not restricted by indexes
     */
