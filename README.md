...
[![Codecov](https://img.shields.io/codecov/c/github/honhimw/meilisearch-rest-client/v1.6)](https://app.codecov.io/github/honhimW/meilisearch-rest-client/tree/v1.6)
...
```groovy
// Gradle
implementation 'io.github.honhimw:meilisearch-rest-client:1.6.0.4'
```
